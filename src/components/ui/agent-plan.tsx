...
// Default initial task data (can be overridden via props)
...
const STATUS_ORDER = ["pending", "in-progress", "need-help", "failed", "completed"];

export interface AgentPlanProps {
  /** Optional initial tasks; uses default demo data if not provided */
  initialTasks?: Task[];
  /** Optional className for the root container */
  className?: string;
}

export function AgentPlan({ initialTasks, className }: AgentPlanProps) {
  const [tasks, setTasks] = useState<Task[]>(initialTasks ?? defaultInitialTasks);

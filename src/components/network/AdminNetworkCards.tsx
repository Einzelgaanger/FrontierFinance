...
const AdminNetworkCards = () => {
  ...
  const quickActions = [
    ...
    { icon: Plus, label: 'Add Member', action: () => console.log('Add member') }
  ];
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-6">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium">{networkStats.totalMembers} Total Members</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Target className="w-5 h-5 text-cyan-300" />
                    <span className="text-sm font-medium">{networkStats.completionRate}% Completion Rate</span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-sm font-semibold text-orange-700">Active Members</p>
                  </div>
                  <p className="text-3xl font-bold text-orange-900">{networkStats.activeMembers}</p>
                  <div className="flex items-center space-x-1">
                    <Flame className="w-4 h-4 text-orange-500" />
                    <span className="text-xs text-orange-600 font-medium">Engaged</span>
                  </div>
                </div>
              ...
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-600">Survey Completion</span>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive analytics and insights about the network
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Detailed analytics and insights about network growth, member engagement, and survey completion rates.
                  </p>
                  <Button 
          ...
          <TabsContent value="management" className="space-y-6">
            <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Administrative tools and network management features
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Admin Tools</h3>
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Access administrative tools for managing network members, permissions, and system settings.
                  </p>
                  <Button 
                    onClick={() => setActiveTab('members')}
...
export default AdminNetworkCards;

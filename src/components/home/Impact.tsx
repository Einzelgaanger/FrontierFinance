...
const Impact = () => {
  return (
    <section className="pt-8 sm:pt-14 lg:pt-16 pb-10 sm:pb-24 lg:pb-24 bg-navy-900 relative overflow-hidden">
      {/* Brighter background */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6">
            ...
            >
              ...
              <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-4xl font-display font-normal text-white mt-2 sm:mt-3 mb-3 sm:mb-6 leading-tight">
                The Impact of <span className="text-gold-300">SGB Financing</span>
              </h2>
              <p className="text-slate-200 mb-5 sm:mb-10 lg:mb-8 leading-snug sm:leading-[1.7] font-sans font-light text-xs sm:text-base lg:text-sm max-w-xl">
              ...
              <ul className="space-y-2 sm:space-y-4 lg:space-y-3">
                {impacts.map((item, index) => (
                  <motion.li
                    ...
                    className="group flex gap-2 sm:gap-4 lg:gap-3 pl-3 sm:pl-5 border-l-2 border-gold-500/40 hover:border-gold-400/60 transition-colors duration-300 py-0.5 sm:py-1"
                  >
                    <span className="text-gold-500/80 text-[10px] sm:text-xs font-medium tabular-nums mt-0.5 shrink-0 w-4 sm:w-6">
                      {String(index + 1).padStart(2, '0')}
                    </span>
                    <div className="min-w-0">
                      <h3 className="text-sm sm:text-lg lg:text-base font-semibold font-sans text-white mb-0.5 sm:mb-1">
                        {item.title}
                      </h3>
                      <p className="text-slate-400 text-[11px] sm:text-sm lg:text-xs leading-snug sm:leading-relaxed max-w-lg">
                        {item.desc}
                      </p>
                    </div>
                  </motion.li>
          ...
          >
            <div className="relative">
              <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wider text-gold-400 mb-2 sm:mb-4 lg:mb-3 font-sans">
                Impact in action
              </p>

...
const Mission = () => {
    return (
        <section className="pt-8 sm:pt-24 lg:pt-28 pb-8 sm:pb-14 lg:pb-16 bg-slate-50/80 relative overflow-hidden">
            <div className="absolute inset-0 bg-slate-50/30" />
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 min-w-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-16 lg:gap-20 items-center">
                    {/* Text */}
                    <motion.div
                    ...
                    >
                        <span className="inline-block text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] sm:tracking-[0.25em] text-gold-600 mb-3 sm:mb-6 font-sans">Our Purpose</span>
                        <h2 className="text-lg sm:text-4xl md:text-5xl lg:text-6xl font-display font-normal text-navy-900 mb-3 sm:mb-6 leading-[1.15]">
                            Bridging the <br />
                        ...
                        <p className="text-xs sm:text-xl text-slate-700 leading-snug sm:leading-[1.75] mb-4 sm:mb-6 font-sans font-light">
                        ...
                        <p className="text-[11px] sm:text-lg text-slate-600 leading-snug sm:leading-relaxed font-sans font-light">
                        ...
                        <p className="text-[11px] sm:text-base text-slate-600 leading-snug sm:leading-relaxed font-sans font-light mt-4 sm:mt-6">
                    ...
                    >
                        ...
                        >
                            <div className="text-4xl sm:text-5xl font-marck font-normal text-gold-400 mb-2 tracking-tight">80%</div>

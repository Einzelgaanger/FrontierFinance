...
const Mission = () => {
    return (
        <section className="pt-12 sm:pt-24 lg:pt-28 pb-10 sm:pb-14 lg:pb-16 bg-slate-50/80 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 min-w-0">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-normal text-navy-900 mb-6 leading-[1.15]">
                            Bridging the <br />
                    ...
                    >
                        <div className="relative">
                            <div className="absolute -top-4 sm:-top-8 -right-4 sm:-right-8 w-full h-full border border-gold-500/40 rounded-2xl z-0" aria-hidden />

                ...
                <div className="flex md:grid md:grid-cols-3 gap-3 sm:gap-6 md:gap-6 lg:gap-8 overflow-x-auto snap-x snap-mandatory md:overflow-visible pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 md:pb-0 scrollbar-hide">
                    {pillars.map((pillar, index) => (
                        <motion.div
                            ...
                            className="group finance-card flex flex-col h-full flex-shrink-0 w-[85vw] min-w-[260px] max-w-[320px] md:w-auto md:min-w-0 md:max-w-none snap-start !shadow-none hover:!shadow-none"
                        >
                            <div className="h-36 sm:h-52 overflow-hidden relative rounded-t-xl sm:rounded-t-2xl">
                                ...
                                <span className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4 inline-flex items-center justify-center min-w-[2rem] h-8 sm:min-w-[2.5rem] sm:h-10 px-2 sm:px-3 rounded-md sm:rounded-lg bg-white/95 text-navy-900 font-display font-normal text-sm sm:text-lg group-hover:bg-gold-500 group-hover:text-white transition-colors duration-300 z-20">

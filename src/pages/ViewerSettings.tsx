      ...
      <header className="sticky top-0 z-20 border-b border-slate-200/60 bg-[#faf6f0]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 sm:py-3">
          <div className="flex flex-wrap items-baseline gap-2 min-w-0">
            ...
            <h1 className="text-base sm:text-lg font-display font-normal text-navy-900">Settings</h1>
            <div className="w-5 h-0.5 bg-gold-500 rounded-full shrink-0" aria-hidden />
            <p className="text-[10px] text-slate-500 font-sans hidden sm:inline">Manage your account and preferences</p>
          </div>
        </div>
      </header>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 min-w-0">
